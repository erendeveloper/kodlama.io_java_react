...
public class FDQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FDQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new FDQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FDQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FDQDateTimeConverter dateTimeConverter = new FDQStandardDateTimeConverter();

    public FDQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FDQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FDQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FDQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FDQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FDQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
