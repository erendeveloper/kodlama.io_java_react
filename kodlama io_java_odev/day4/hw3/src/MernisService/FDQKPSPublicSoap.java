...
public class FDQKPSPublicSoap
{
    ...
    public FDQKPSPublicSoap(){}

    public FDQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FDQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FDQExtendedSoapSerializationEnvelope envelope= new FDQExtendedSoapSerializationEnvelope(FDQExtendedSoapSerializationEnvelope.VER11);
