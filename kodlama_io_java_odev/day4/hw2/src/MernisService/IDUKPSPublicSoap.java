...
public class IDUKPSPublicSoap
{
    ...
    public IDUKPSPublicSoap(){}

    public IDUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IDUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IDUExtendedSoapSerializationEnvelope envelope= new IDUExtendedSoapSerializationEnvelope(IDUExtendedSoapSerializationEnvelope.VER11);
