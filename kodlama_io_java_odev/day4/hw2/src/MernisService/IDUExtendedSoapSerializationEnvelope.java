...
public class IDUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IDUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IDUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IDUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IDUDateTimeConverter dateTimeConverter = new IDUStandardDateTimeConverter();

    public IDUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IDUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IDUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IDUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IDUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IDUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
