...
public class FHEKPSPublicSoap
{
    ...
    public FHEKPSPublicSoap(){}

    public FHEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FHEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FHEExtendedSoapSerializationEnvelope envelope= new FHEExtendedSoapSerializationEnvelope(FHEExtendedSoapSerializationEnvelope.VER11);
