...
public class FHEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FHEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new FHEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FHEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FHEDateTimeConverter dateTimeConverter = new FHEStandardDateTimeConverter();

    public FHEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FHEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FHEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FHEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FHEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FHEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
